...
//    GKVideoPlayCell *cell = [GKVideoPlayCell cellForTableView:tableView indexPath:indexPath];
...
//    GKVideoPlayHeaderView *head = [[GKVideoPlayHeaderView alloc] initWithReuseIdentifier:NSStringFromClass(GKVideoPlayHeaderView.class)];
//    [head.imageV sd_setImageWithURL:[NSURL URLWithString:self.model.thumbnail_url] placeholderImage:placeholder];
//    head.titleLab.text = self.model.nickName ?:@"";
//    head.subTitleLab.text = [NSString stringWithFormat:@"分享次数:%@",self.model.share_num];
//    return head;
//}
//- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
//    [tableView deselectRowAtIndexPath:indexPath animated:YES];
//    self.model = self.listData[indexPath.row];
//    [self loadData];
//}
- (void)playSet{
    if (!self.wifi) {
