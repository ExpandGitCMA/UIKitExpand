...
- (void)loadUI{
    ...
    [self.backBtn mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.equalTo(self.backBtn.superview).offset(STATUS_BAR_HIGHT+2);
    }];
...
- (NSMutableAttributedString*)getTitle:(NSString*)str {
    ...
    [attributedString addAttribute:NSParagraphStyleAttributeName value:paragraphStyle range:[str rangeOfString:str]];
    [attributedString addAttribute:NSFontAttributeName value:[UIFont systemFontOfSize:16.0] range:[str rangeOfString:str]];
    [attributedString addAttribute:NSUnderlineStyleAttributeName value:[NSNumber numberWithInteger:NSUnderlineStyleNone] range:[str rangeOfString:str]];
