...
- (void)setObject:(id)object{
    ...
    if ([object isKindOfClass:UIImage.class]) {
        ...
        [self.imageV sd_setImageWithURL:[NSURL URLWithString:object] placeholderImage:placeholder completed:^(UIImage * _Nullable image, NSError * _Nullable error, SDImageCacheType cacheType, NSURL * _Nullable imageURL) {
            self.image = image;
        }];
    }
}
