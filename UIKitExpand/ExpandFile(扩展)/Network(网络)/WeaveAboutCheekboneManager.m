...
@interface WeaveAboutCheekboneManager ()
@property (strong,nonatomic) AFHTTPSessionManager *manager;
@end


@implementation WeaveAboutCheekboneManager

+ (instancetype)sharedManager{
    static dispatch_once_t onceToken;
    static WeaveAboutCheekboneManager *manager = nil;
