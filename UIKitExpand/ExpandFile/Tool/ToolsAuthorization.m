...
- (void)getCamera{
    NSString*message = [NSString stringWithFormat:@"%@%@%@",@"请在iPhone的""设置-",@"优速体育社区-足球" ,@"-相机中允许使用相机"];
...
- (void)getAlbums{
      NSString*message = [NSString stringWithFormat:@"%@%@%@",@"请在iPhone的""设置-",@"优速体育社区-足球",@"-相册中允许使用相机"];
