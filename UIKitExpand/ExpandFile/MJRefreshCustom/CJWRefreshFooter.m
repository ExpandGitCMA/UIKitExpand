...
- (void)prepare
{
    ...
    tipL.textColor = [UIColor darkGrayColor];
...
- (void)placeSubviews
{
    ...
    self.noMoreLeftLineV.frame = CGRectMake(self.mj_w * 0.5-74.f-64.f, (self.mj_h-1.f)*0.5, 64.f, CJW_1PX_WIDTH);
    self.noMoreRightLineV.frame = CGRectMake(self.mj_w * 0.5+74.f, (self.mj_h - 1.f) * 0.5, 64.f, CJW_1PX_WIDTH);
}
