...
-(void)setupNavView{
    ...
    [backBtn setBackgroundImage:[UIImage imageNamed:@"scan_titlebar_back_nor"] forState:UIControlStateNormal];
    ...
    [albumBtn setBackgroundImage:[UIImage imageNamed:@"scan_btn_photo_down"] forState:UIControlStateNormal];
    ...
    [flashBtn setBackgroundImage:[UIImage imageNamed:@"scan_btn_flash_down"] forState:UIControlStateNormal];
