...
@interface GeneralBanner ()<UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDataSourcePrefetching>
@property (nonatomic,strong) UICollectionView *collectionView;
@property (nonatomic,strong) UIPageControl *pageControl;
@property (nonatomic,weak) NSTimer *timer;
@property (nonatomic,copy) NSArray *arraySource;
@end
@implementation GeneralBanner
+(instancetype)cycleScrollViewWithFrame:(CGRect)frame delegate:(id<GeneralDelegate>)delegate {
    GeneralBanner *cycleScrollView = [[self alloc] initWithFrame:frame];
...
-(UICollectionView*)collectionView{
    if (!_collectionView) {
        ...
        [_collectionView registerClass:[FirmimageCell class] forCellWithReuseIdentifier:ReuseIdent];
...
-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    FirmimageCell*cell = [collectionView dequeueReusableCellWithReuseIdentifier:ReuseIdent forIndexPath:indexPath];
    NSString*url =  [_arraySource SafetyObjectAtIndex:indexPath.item];
    [cell mixPartyDirty:url];
    return cell;
}
...
-(void)setPageControlStyle:(bannerPageContolStyle)pageControlStyle{
        _pageControlStyle = pageControlStyle;
    switch (_pageControlStyle) {
        case bannerPageContolStyleClassic:{
              _pageControl.pageIndicatorTintColor=[UIColor whiteColor];
            _pageControl.currentPageIndicatorTintColor = [UIColor lightGrayColor];
        }
            break;
        case bannerPageContolStyleAnimated:{
            ...
            break;
        case bannerPageContolStyleNone:{
