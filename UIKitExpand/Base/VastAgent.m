...
@interface VastAgent ()<UITabBarDelegate>
...
-(void)addSubController{
    ConvertMenuController *homePage = [[ConvertMenuController alloc]init];
    [self tabBarControllers:homePage  title:@"首页" imageUrl:@"icon-home"];
    PretendPlateController *score = [[PretendPlateController alloc]init];
    [self tabBarControllers:score title:@"球赛规则" imageUrl:@"score"];
    DoubtRenewableTwinController *personal = [[DoubtRenewableTwinController alloc]init];
